...
namespace MCP_WEB.Controllers.WebAPI
{
    ...
    //[ApiController]
    public class GridSummaryWIPController : Controller
    {
        private NittanDBcontext _context;
        public GridSummaryWIPController(NittanDBcontext context)
        {
        ...
        public IActionResult Print(string RowNumber, string fromdate)
        {
            ...
            var Log_Select_Print = _context.Log_Select_Print.Where(w => w.opt == "PrintSummaryWIP");

            var flag = false;
            flag = LogPrint.Log_Print(RowNumber, "PrintSummaryWIP", token, username, _context);
